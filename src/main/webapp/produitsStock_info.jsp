...
<body class="animsition">
	...
	<div class="page-wrapper">
		...
		<div class="page-container">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<h3 class="title-3 m-b-30">
									<i class="zmdi "></i>Produit stock information
								</h3>
			...
			<th>Quantité d'un Produit</th>
			<th>Description</th>
			<th>code ProduitStock</th>
			<th>Date</th>
			<th></th>
										</tr>
									</thead>
				...
				<td><s:property value="codeProduitStock" /></td>
				<td><s:property value="dateProduitStock" /></td>
				<%-- 				<td><a href="delete?id=<s:property value="codeProduitStock" />" --%>
				<!-- 					onClick="return confirm('Voulez-vous supprimer le Produit stock?');">Delete</a></td> -->
				<td><s:url action="edit" var="editurl">
						<s:param name="id">
							<s:property value="codeProduitStock" />
						</s:param>
					</s:url> <s:a href="%{editurl}"><button class="btnE danger"><p style="color:#FFFFFF">Edit</p></button></s:a></td>
											</tr>
										</s:iterator>
									</tbody>
								</table>
