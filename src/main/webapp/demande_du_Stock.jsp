...
<body class="animsition">
	<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<s:form action="produitStock_a_une_date" styleClass="form-horizontal" theme="simple">
				<div class="modal-content">
					<div class="modal-header">
						<h6 class="title-3 m-b-20" id="exampleModalLabel">Recherche un demande du stock</h6>
					...
					<div class="modal-body">
						...
						<div class="card-body card-block">
							...
							<div class="row form-group">
								<div class="col-sm-3">Date de stock</div>
								<div class="col-sm-9">
					...
					<div class="modal-footer">
						...
						<s:submit label="Recherche" cssClass="btn btn-danger" theme="simple"  value="Recherche"/>
					</div>
				</div>
			</s:form>
		</div>
			...
			<div class="header-mobile__bar">
				<div class="container-fluid">
					<div class="header-mobile-inner">
						...
						<img src="images/icon/test1.png" alt="CoolAdmin" />
						</a>
			...
			<div class="menu-sidebar__content js-scrollbar1">
				<nav class="navbar-sidebar">
					<ul class="list-unstyled navbar__list">
						...
						<li class="active"><a href="produitStock_a_une_date"> <i
					...
					<div class="container-fluid">
						<div class="row">
							<!-- 							<a href="acceuil">Acceuil</a> <a href="produitStock_a_une_date">Stock
								a une date</a> <a href="ProduitApprovisionnement">Produits Approvisionnement</a> <a href="index">Produit Stock</a> -->
							<div class="col-sm-6">
								<h3 class="title-3 m-b-30">
									<i class="zmdi "></i>Demande du stock
								</h3>
									...
									<div class="input-group-append">
										...
										<div class="dropdown-menu dropdown-menu-right">
											<button class="dropdown-item" type="button"
												data-toggle="modal" data-target="#exampleModal">Demande du stock
												</button>
										</div>
							...
							<div class="table table-borderless table-data3 ">
								<table id="datatableG"
									...
									<thead>
										<tr>
											<th>Nom de Produit Approvisionnement</th>
											<th>Quantitee Produit Approvisionnement</th>
										</tr>
									</thead>
									<tbody id="datatable">
										<s:iterator value="produitStock_shown" var="produitStock">
											<tr>
